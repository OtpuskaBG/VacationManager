...
public class CreateAndEditTeamAuthorizationTests : Bunit.TestContext
{
    private readonly TestAuthorizationContext _authContext;

    private CreateAndEditTeamAuthorizationTests()
    {
        ...
        mockCourseService
            ...
            .ReturnsAsync((Project?)new()); // Simulate "course not found"
        Services.AddScoped(_ => mockCourseService.Object);

        var mockModuleService = new Mock<ITeamService>();
        mockModuleService
            .Setup(service => service.GetByIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((VacationManager.Data.Models.Team?)new()); // Simulate "module not found"
    ...
    [Fact]
    public void CEOCanAccessCreateTeam()
    {
        _authContext.SetRoles(Role.CEO.ToString());

        var cut = RenderComponent<VacationManager.Components.Pages.Team.Create>();
    ...
    [Fact]
    public void CEOCanAccessEditTeam()
    {
        _authContext.SetRoles(Role.CEO.ToString());

        var cut = RenderComponent<VacationManager.Components.Pages.Team.Edit>();
    ...
    [Fact]
    public void TeamLeadCannotAccessCreateTeam()
    {
    ...
    [Fact]
    public void TeamLeadCannotAccessEditTeam()
    {
        _authContext.SetRoles(Role.TeamLead.ToString());
    ...
    [Fact]
    public void DeveloperCannotAccessCreateTeam()
    {
    ...
    [Fact]
    public void DeveloperCannotAccessEditTeam()
    {
        _authContext.SetRoles(Role.Developer.ToString());
    ...
    [Fact]
    public void UnassignedCannotAccessCreateTeam()
    {
    ...
    [Fact]
    public void UnassignedCannotAccessEditTeam()
    {
        _authContext.SetRoles(Role.Unassigned.ToString());
